...
export default function VerifyRegisterOtp() {
  ...
  // Retrieve email from routing state if redirected from register page
  ...
  const onSubmit = async (data) => {
    setLoading(true);
    try {
      await verifyRegisterOtp(data.email, data.otp);
    ...
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center p-6 relative z-10">
      <div className="glass-card rounded-2xl p-8 max-w-md w-full border-dark-700/40 shadow-2xl flex flex-col gap-6 text-left">
        ...
        <div className="flex flex-col items-center text-center gap-2">
          ...
          <h2 className="font-display font-bold text-xl sm:text-2xl text-white">Verify Registration</h2>
        ...
        <div className="text-center text-xs text-dark-400 font-medium">
          ...
          <Link to={ROUTES.REGISTER} className="text-primary-500 hover:text-primary-400 transition-colors">
